...
public class Main {
	...
	//·Método init
	private static void init() { //Construye todos los Builders
		
		// TODO initialize the bodies factory
		ArrayList<Builder<Body>> bodyBuilders = new ArrayList<>();
		bodyBuilders.add(new BasicBodyBuilder());
		bodyBuilders.add(new MassLosingBodyBuilder());
		_bodyFactory = new BuilderBasedFactory<Body>(bodyBuilders); //Le pasamos la lista de builders de body
		...
		_forceLawsFactory = new BuilderBasedFactory<ForceLaws>(forceLawsBuilders); //Le pasamos la lista de builders de leyes
		...
		_stateComparatorFactory = new BuilderBasedFactory<StateComparator>(stateCmpBuilders); //Le pasamos la lista de builders de comparadores
	}
	...
	private static void parseArgs(String[] args) {
		...
		try {
			...
			parseOutFileOption(line);//Parseo de Salida
            parseStepsOption(line);  //
			parseExpectedOutOption(line);//Parseo de Salida Esperada
	...
	//·Método startBatchMode
	private static void startBatchMode() throws Exception { //Arranca el controlador
	...
	//·Método parseOutFileOption
	private static void parseOutFileOption(CommandLine line) throws ParseException{
        _outFile = line.getOptionValue("o");
    }
	
	//·Método parseStepsOption
	...
	//·Método parseExpectedOutOption
    private static void parseExpectedOutOption(CommandLine line) throws ParseException {
